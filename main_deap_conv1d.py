...
print('======================================= ANN =======================================')
model_ANN = ANNs.EEGANN1(input_size=32, num_classes=2, time_windows=64).to(device)
...
print('======================================= SNN =======================================')
model_SNN = SNNs.EEGSNN1(input_size=32, num_classes=2, thresh=1.0, tau=2.0, hete_th=0.0, hete_tau=0.0, train_th=False, train_tau=False, P=1, time_windows=64).to(device)
...
print('======================================= BSNN =======================================')
model_BSNN = SNNs.EEGSNN1(input_size=32, num_classes=2, thresh=1.0, tau=2.0, hete_th=0.01, hete_tau=0.01, train_th=True, train_tau=True, P=1, time_windows=64).to(device)
...
print('======================================= ISNN =======================================')
model_ISNN = SNNs.EEGSNN1(input_size=32, num_classes=2, thresh=1.0, tau=2.0, hete_th=0.0, hete_tau=0.0, train_th=False, train_tau=False, P=1, time_windows=64).to(device)
...
print('=================================== BISNN ===================================')
model_BISNN = SNNs.EEGSNN1(input_size=32, num_classes=2, thresh=1.0, tau=2.0, hete_th=0.01, hete_tau=0.01, train_th=True, train_tau=True, P=1, time_windows=64).to(device)
